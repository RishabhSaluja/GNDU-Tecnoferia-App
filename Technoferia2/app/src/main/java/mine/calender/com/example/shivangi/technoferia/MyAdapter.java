...
/**
 * Created by SHIVANGI on 3/18/2016.
 */
    ...
    public void onClick(View v) {
        ...
        switch (position){
            case 1:
                ...
                intent =  new Intent(contxt, events2.class);
            ...
            case 2:
                ((Activity)contxt).finish();
                intent =  new Intent(contxt, Schedule.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                contxt.startActivity(intent);
                break;
            ...
            case 3:
                ((Activity)contxt).finish();
                intent =  new Intent(contxt, Register.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                contxt.startActivity(intent);
                break;
            case 4:
                ((Activity)contxt).finish();
                intent =  new Intent(contxt, Notification.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                contxt.startActivity(intent);
                break;
            case 5:
                ((Activity)contxt).finish();
                intent=new Intent(contxt,Navigation.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                contxt.startActivity(intent);
                break;
            case 6:
                ((Activity)contxt).finish();
                intent=new Intent(contxt,Info.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                contxt.startActivity(intent);
                break;
            default:
